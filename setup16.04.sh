...
[[ $(lsb_release -rs) == "16.04" ]] || exit_badly "This script is for Ubuntu 16.04 only, aborting"
...
apt-get install -y language-pack-en strongswan strongswan-ikev2 libstrongswan-standard-plugins strongswan-libcharon libstrongswan libcharon-extra-plugins moreutils iptables-persistent postfix mailutils unattended-upgrades letsencrypt
...
letsencrypt certonly --agree-tos --email $EMAIL -d $VPNHOST
